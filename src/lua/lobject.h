...
*/
#define setnvalue(obj,x) { lua_Number i_x = (x); TValue *i_o=(obj); i_o->value.n=i_x; i_o->tt=LUA_TNUMBER; }

#ifdef LUA_TINT
# define setivalue(obj,x) { lua_Integer i_x = (x); TValue *i_o=(obj); i_o->value.i=i_x; i_o->tt=LUA_TINT; }
#else
